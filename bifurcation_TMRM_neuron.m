...
%% vary with phi
% alpha=0;delta=0.8;mu=0.1;%phi=0.2;
% A=1;
% omega=0.942;
...
%% vary with A
parameter_a(1,:)=[-0.46,0,0.29,0];
parameter_a(2,:)=[1.76,1.16,-0.21,0.6];
% parameter_a(1,:)=[0.1,0,0.2,0];
% parameter_a(2,:)=[6,-7,-4,10];
%% vary with phi
% parameter_a(1,:)=[-0.46,0,0.29,0];% stable_period1 and period3
% parameter_a(2,:)=[-4.5,1.16,-0.21,0.6];
% parameter_a(1,:)=[-8.48,0,-4.56,0]; % unstable_period1
% parameter_a(2,:)=[1.15,-0.64,0.28,0.29];
% parameter_a(1,:)=[-0.46,0,0.29,0]; % unstable_period3
% parameter_a(2,:)=[1.76,1.16,-0.21,0.6];
%%
